...
```html
<script src="https://js.firstclasspostcodes.com/plugin/v2.1.0.js"></script>
```
...
```sh
$ curl https://js.firstclasspostcodes.com/plugin/v2.1.0.sri.txt # => "sha256-45tfd... sha384-43567ytr..."
```

You can then update the above `<script>` tag, adding the integrity attribute:

```html
<script src="https://js.firstclasspostcodes.com/plugin/v2.1.0.js"
