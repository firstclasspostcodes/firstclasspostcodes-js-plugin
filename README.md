...
```html
<script src="https://js.firstclasspostcodes.com/plugin/v1.0.2.js"></script>
```
...
```sh
$ curl https://js.firstclasspostcodes.com/plugin/v1.0.2.sri.txt # => "sha256-45tfd... sha384-43567ytr..."
```

You can then update the above `<script>` tag, adding the integrity attribute:

```html
<script src="https://js.firstclasspostcodes.com/plugin/v1.0.2.js"
